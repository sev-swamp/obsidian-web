...
const en = {
  ...
  tabPlugins: 'Plugins',
  tabNotes: 'Notes',
  propertiesSection: 'Note properties',
  propertiesHint:
    'Properties are discovered automatically from note frontmatter. Uncheck a property to hide it from the panel; the label overrides how it is captioned.',
  showPropertiesToggle: 'Show properties under the note title',
  propertyLabel: 'Label',
  noPropertiesFound: 'No frontmatter properties found in the vault yet.',
...
const ru: Record<TKey, string> = {
  ...
  tabPlugins: 'Плагины',
  tabNotes: 'Заметки',
  propertiesSection: 'Свойства заметок',
  propertiesHint:
    'Свойства находятся автоматически по frontmatter заметок. Снимите галочку, чтобы скрыть свойство из панели; подпись переопределяет его название.',
  showPropertiesToggle: 'Показывать свойства под заголовком заметки',
  propertyLabel: 'Подпись',
  noPropertiesFound: 'Свойства frontmatter в хранилище пока не найдены.',
